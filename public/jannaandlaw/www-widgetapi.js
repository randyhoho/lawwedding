...
var ic;a:{var jc="",kc=function(){var a=Jb();if(ec)return/rv:([^\);]+)(\)|;)/.exec(a);if(dc)return/Edge\/([\d\.]+)/.exec(a);if(cc)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(fc)return/WebKit\/(\S+)/.exec(a);if(bc)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
kc&&(jc=kc?kc[1]:"");if(cc){var lc=gc();if(null!=lc&&lc>parseFloat(jc)){ic=String(lc);break a}}ic=jc}var mc=ic,nc;if(A.document&&cc){var oc=gc();nc=oc?oc:parseInt(mc,10)||void 0}else nc=void 0;var pc=nc;var qc=$b()||E("iPod"),rc=E("iPad");!E("Android")||Kb();Kb();var vc=E("Safari")&&!(Kb()||E("Coast")||E("Opera")||E("Edge")||E("Edg/")||E("OPR")||E("Firefox")||E("FxiOS")||E("Silk")||E("Android"))&&!($b()||E("iPad")||E("iPod"));var wc={},xc=null;
...
;var zc="undefined"!==typeof Uint8Array;var Ac="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Bc(a,b){Object.isFrozen(a)||(Ac?a[Ac]|=b:void 0!==a.sa?a.sa|=b:Object.defineProperties(a,{sa:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
...
;function Nc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)&&zc&&null!=a&&a instanceof Uint8Array)return yc(a)}return a}
...
function Pc(a){return zc&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
...
bd.prototype.isMutable=function(a){if(a!==Zb)throw Error("requires a valid immutable API token");return!Ec(this.D)};
...
ae.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.i=b;if(b=a.relatedTarget){if(ec){a:{try{ac(b.nodeName);var e=!0;break a}catch(f){}e=!1}e||(b=null)}}else"mouseover"==c?b=a.fromElement:"mouseout"==c&&(b=a.toElement);this.relatedTarget=b;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||
...
;function Di(a){a=Object.assign({},a);delete a.Authorization;var b=Td();if(b){var c=new Lf;c.update(N("INNERTUBE_API_KEY"));c.update(b);a.hash=yc(c.digest(),3)}return a}
...
Qi.prototype.start=function(){var a=B("yt.scheduler.instance.start");a&&a()};var De=Ri();var Si=qc||rc;var Ti=function(){var a;return function(){a||(a=new Ei("ytidb"));return a}}();
...
function Qk(){var a,b,c,d;return x(function(e){switch(e.i){case 1:a=Ui();if(null==(b=a)?0:b.hasSucceededOnce)return e.return(!0);var f;if(f=Si)f=/WebKit\/([0-9]+)/.exec(Jb()),f=!!(f&&600<=parseInt(f[1],10));f&&(f=/WebKit\/([0-9]+)/.exec(Jb()),f=!(f&&602<=parseInt(f[1],10)));if(f||dc)return e.return(!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e.return(!1)}catch(g){return e.return(!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return e.return(!1);
...
;function wn(){var a;return x(function(b){return(a=Xe())?b.return(a.then(function(c){c=dd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return yc(d,3)})):b.return(Promise.resolve(null))})}
